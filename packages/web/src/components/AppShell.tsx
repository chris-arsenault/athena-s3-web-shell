...
/**
 * Console chrome: header on top, work surface below, status bar at the
 * bottom. The old left-hand activity rail is gone — module switching
 * happens via the sidebar's WORKSPACE section (browser tabs) and the
 * TabStrip (SQL tabs), so a dedicated nav column is redundant.
 */
